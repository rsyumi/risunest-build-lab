export const languageKorean = {
    ...
    "resetAllPluginPermissions": "플러그인 권한 초기화",
    "resetAllPluginPermissionsConfirm": "모든 플러그인의 저장된 권한을 초기화하시겠습니까?\n\n다음에 플러그인이 권한을 요청할 때 다시 묻게 됩니다.",
    "resetAllPluginPermissionsDone": "플러그인 권한을 초기화했습니다",
    ...
    "mcpStdioModuleImportBlocked": "로컬 MCP 프로그램 실행 설정이 포함되어 있어 모듈을 가져올 수 없습니다. 로컬 MCP는 모듈 설정에서 직접 등록해주세요.",
    "mcpStdioRegisterConfirm": "이 MCP를 등록하면 아래에 설정된 프로그램이 사용자 권한으로 컴퓨터에서 실행됩니다. 프로그램은 파일과 네트워크에 접근할 수 있으며, 모듈이 활성화된 동안 다시 실행될 수 있습니다. 신뢰하는 프로그램만 등록해주세요. 프로그램을 실행하고 MCP를 등록하시겠습니까?",
    ...
    risuNest: {
        ...
        cleanup: {
            ...
            deleteAndExit: '삭제 후 종료',
            confirmReset: '로컬 데이터를 삭제하고 RisuNest를 초기화하시겠습니까?',
            confirmRemoval: '로컬 데이터를 삭제하고 RisuNest 제거를 준비하시겠습니까?',
            failed: '로컬 데이터 삭제를 시작하지 못했습니다. 다시 시도해주세요.',
        },
        platform: {
